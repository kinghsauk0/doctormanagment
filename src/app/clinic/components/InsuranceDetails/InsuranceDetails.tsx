        ...
        <div className="flex align-items-center gap-2">
            <div className='flex gap-4 items-center'>
                ...
                <div>
                    ...
                    <div className="text-10px text-[#667085]">Details about Insurance information</div>
                </div>
            </div>
        </div>
    );
        ...
        <Sidebar header={AddPatientHeader} visible={visible} position="right" onHide={() => setVisible(false)} className="w-full md:w-[500px]">
            <div className='flex flex-col gap-4 h-full'>
                <div className="flex flex-col gap-3">
                    <div className="text-lg font-semibold text-[#000]">Enter Your Insurance Details</div>
                    <div className="">
