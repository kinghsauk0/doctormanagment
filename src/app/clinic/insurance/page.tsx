...
export default function Page() {
    ...
    return <>
                ...
                <div style={{height:'calc(100vh - 145px)', overflow:'auto'}}>
                    <div className="lg:px-10 md:px-6 px-4">
                        <div className="p-4 bg-white rounded-md">
                            <div className="mb-4 font-semibold"><span className="border-r-4 border-solid border-l-0 border-b-0 border-t-0 border-[#4BAC3B] pr-2">Insurance Lists</span></div>
        ...
        <InsuranceDetails visible={paymentVisible} setVisible={setPaymentVisible} />
    </>
}