...
export default function page() {
    ...
    const EditProfileHeader = (
        <div className="flex align-items-center gap-2">
            <div className='flex gap-4 items-center'>
                <Button icon="pi pi-arrow-left" className='p-0 bg-white border-0 shadow-none text-[#222] w-auto' onClick={() => setEditProfileVisible(false)} />
    ...
    const LanguageHeader = (
        <div className="flex align-items-center gap-2">
            <div className='flex gap-4 items-center'>
                <Button icon="pi pi-arrow-left" className='p-0 bg-white border-0 shadow-none text-[#222] w-auto' onClick={() => setLanguageVisible(false)} />
    ...
    const AboutHeader = (
        <div className="flex align-items-center gap-2">
            <div className='flex gap-4 items-center'>
                <Button icon="pi pi-arrow-left" className='p-0 bg-white border-0 shadow-none text-[#222] w-auto' onClick={() => setAboutVisible(false)} />
    ...
    const HelpHeader = (
        <div className="flex align-items-center gap-2">
            <div className='flex gap-4 items-center'>
                <Button icon="pi pi-arrow-left" className='p-0 bg-white border-0 shadow-none text-[#222] w-auto' onClick={() => setAboutVisible(false)} />
                <div className='font-semibold text-base text-[#222]'>Help & Support</div>   
            </div>
        </div>
    );
  return (
    <>
                    ...
                    <div className="max-w-[500px] mx-auto flex flex-col gap-4">
                        <div className='flex flex-col gap-6'>
                            <div className="flex gap-2 items-center p-3 rounded-md bg-white">
                                ...
                                <div className="">
                                    <div className="text-lg text-[#222] font-semibold">Steven Jobs</div>
                            ...
                            <div className='flex flex-col gap-3 p-3 rounded-md bg-white'>
                                ...
                                <Button className='flex items-center gap-2 bg-[#F1F9FE] text-[#222] border-[#F1F9FE] py-4 shadow-none' onClick={() => setAboutVisible(true)}>
                                    <i style={{lineHeight:'0'}}>
                                        <svg height="18" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"><g fill="rgb(0,0,0)"><path d="m12 0a12 12 0 1 0 12 12 12.013 12.013 0 0 0 -12-12zm0 22a10 10 0 1 1 10-10 10.011 10.011 0 0 1 -10 10z"/><path d="m12 9a1 1 0 0 0 -1 1v8a1 1 0 0 0 2 0v-8a1 1 0 0 0 -1-1z"/><circle cx="12" cy="6" r="1"/></g></svg>
                                    </i>
                                    <span>About Us</span>
                                    <i className='ml-auto' style={{lineHeight:'0'}}>
                                        <svg height="16" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m22.707 11.293-7-7a1 1 0 0 0 -1.414 1.414l5.293 5.293h-17.586a1 1 0 0 0 0 2h17.586l-5.293 5.293a1 1 0 1 0 1.414 1.414l7-7a1 1 0 0 0 0-1.414z"/></svg>
                                ...
                                <Button className='flex items-center gap-2 bg-[#F1F9FE] text-[#222] border-[#F1F9FE] py-4 shadow-none'>
                                    <i style={{lineHeight:'0'}}>
                                        <svg height="18" viewBox="0 0 100 100" width="18" xmlns="http://www.w3.org/2000/svg"><path d="m50 99a44.33 44.33 0 0 1 -25.54-80.55 4 4 0 1 1 4.62 6.55 36.32 36.32 0 1 0 41.84 0 4 4 0 1 1 4.62-6.53 44.33 44.33 0 0 1 -25.54 80.53zm0-40.32a4 4 0 0 1 -4-4v-49.68a4 4 0 0 1 8 0v49.68a4 4 0 0 1 -4 4z"/></svg>
                                    </i>
                                    <span>Sign Out</span>
                                </Button>
                            </div>
        ...
        <Sidebar header={EditProfileHeader} visible={editprofilevisible} position="right" onHide={() => setEditProfileVisible(false)} className="w-full md:w-[500px]">
            <div className='flex flex-col h-full text-center'>
                ...
                <div className="mt-auto">
                    <Link href="/account-created">
                        <Button className="bg-[#0D52AF] text-[#fff] text-sm border-[#0D52AF] w-full" label="Save"/>
                    </Link>
                </div>
            </div>
        </Sidebar>
        <Sidebar header={LanguageHeader} visible={languagevisible} position="right" onHide={() => setLanguageVisible(false)} className="w-full md:w-[500px]">
            <div className='flex flex-col h-full text-center'>
                <div className="flex flex-col gap-3">
                    <div className="">
                        <Dropdown value={selectedLanguage} onChange={(e) => setSelectedLanguage(e.value)} options={languages} optionLabel="name" 
                        placeholder="Select Language" className="w-full bg-[#F3F3F5] border-[#F3F3F5] shadow-none text-left" />
                    </div>
                </div>
                <div className='mt-auto'>
                    <Button className="bg-[#0D52AF] text-[#fff] text-sm border-[#0D52AF] w-full" label="Save"/>
        ...
        <Sidebar header={AboutHeader} visible={aboutvisible} position="right" onHide={() => setAboutVisible(false)} className="w-full md:w-[500px]">
            <div className='flex flex-col h-full text-center'>
                <div className="flex flex-col gap-3">
                    <div className="">
                        <InputTextarea rows={6} v-model="value1" className="w-full bg-[#F3F3F5] border-[#F3F3F5] shadow-none" placeholder="Type About Details" />
                    </div>
        ...
        <Sidebar header={HelpHeader} visible={helpvisible} position="right" onHide={() => setHelpVisible(false)} className="w-full md:w-[500px]">
            <div className='flex flex-col h-full'>
                <div className='text-lg mb-2'>demomail@mail.com</div>
                <div className=''>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </div>
            </div>
        </Sidebar>
    </>
  )
